...
const BoardAdmin = () => {
  ...
  useEffect(() => {
    axios.get("http://localhost:8081/findAllTrains").then((res) => {
  ...
  if (content === "Admin Board.") {
          ...
          >
            <TableHead>
              <TableRow>
                ...
                <StyledTableCell>
                  <strong>ACfare</strong>
                </StyledTableCell>
                <StyledTableCell>
                  <strong>SleeperFare</strong>
                </StyledTableCell>
                <StyledTableCell>
                ...
                <TableRow key={trains.id}>
                  ...
                  <StyledTableCell>
                    <UpdateOutlinedIcon
                      ...
                      variant="contained"
                      color="primary"
                      onClick={() => updatehandler(trains.trainNumber)}
                    >
                      Update
                    </UpdateOutlinedIcon>
                  ...
                  <StyledTableCell>
                    <DeleteOutlinedIcon
                      ...
                      variant="contained"
                      color="secondary"
                      onClick={() => deletehandler(trains.trainNumber)}
                    >
                      Delete{" "}
                    </DeleteOutlinedIcon>
                  </StyledTableCell>
    ...
    return (
      ...
      >
        ...
        <center>You ARE not authorized to access this content</center>
      </div>
    );
  }
};
