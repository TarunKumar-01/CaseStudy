...
export default class bookingconfirm extends Component {
  constructor(props) {
    ...
    this.changecoachTypeHandler = this.changecoachTypeHandler.bind(this);
    this.changepassengerNameHandler =
      this.changepassengerNameHandler.bind(this);
  ...
  changecoachTypeHandler = (event) => {
    this.setState({ coachType: event.target.value });
  };
              ...
              <div className="card-body">
                <form>
                  <div className="form-group">
                    ...
                    <select
                      placeholder="coachType"
                      name="coachType"
                      className="form-control"
                      value={this.state.coachType}
                      onChange={this.changecoachTypeHandler}
                    >
                      <option>AC</option>
                    ...
                    <input
                      ...
                      onChange={this.changepassengerNameHandler}
                      required
                    />
