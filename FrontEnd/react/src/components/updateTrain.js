    ...
    componentDidMount(){
        trainService.getTrainsById(this.state.trainNumber).then((res)=>{
            ...
            this.setState({trainName:traindata.trainName,
                ...
                date:traindata.date,
                time:traindata.time,
                acFare:traindata.trainFares.acFare,
                            ...
                            <form>
                                ...
                                <lable>Train number</lable>
                                    ...
                                    <input type="time" placeholder="time" name="time" className="form-control"
                                        ...
                                        <input type="number" placeholder="acFare" name="acFare" className="form-control"
                                            value={this.state.acFare} onChange={this.changeacFareHandler}required/>
